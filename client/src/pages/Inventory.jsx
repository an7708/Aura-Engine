    ...
    // FIX 1: Track previous params to skip fetch if nothing changed
    ...
    const fetchInventory = useCallback(async () => {
        ...
        // FIX 2: Skip fetch if params are identical to last fetch
    ...
    // FIX 3: Reset page to 1 when filters change — also clear prev params
    ...
    // FIX 4: Safe page navigation — guards against going out of bounds
    ...
    // useEffect(() => { fetchInventory(); }, [fetchInventory]);
    // useEffect(() => { setPage(1); }, [search, category, minPrice, maxPrice, maxStock]);
